...
declare -a paireds_epilogos=("Cancer_vs_Non-cancer" "Immune_vs_Non-immune" "Male_vs_Female" "Neural_vs_Non-neural" "Stem_vs_Non-stem")

declare -a paireds_altius=("Cancer_vs_Non-cancer" "Immune_vs_Non-immune" "Male_vs_Female" "Neural_vs_Non-neural" "Stem_vs_Non-stem")
...
do
	...
	do
		...
		src_fn=/net/seq/data/projects/Epilogos/epilogos_output/paired/human/${dataset}/${assembly}/${state}/${paired_altius}/${saliency}/regionsOfInterest_${paired_altius}_${saliency,,}.txt
		alt_src_fn=/net/seq/data/projects/Epilogos/epilogos_output/paired/human/${dataset}/${assembly}/${state}/${paired_altius}/${saliency}/regionsOfInterest_${paired_altius,,}_${saliency,,}.txt
