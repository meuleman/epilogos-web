...
declare -a singles_epilogos=(All_833_biosamples Female Immune Male Neural Stem)

declare -a singles_altius=(All_833_biosamples Female Immune Male Neural Stem)
