...
do
	...
	do
		...
		alt_v2_src_fn=/net/seq/data/projects/Epilogos/epilogos_output/single/human/${dataset}/${assembly}/${state}/${single_altius}/${saliency}/regionsOfInterest_all833_${saliency,,}.txt
